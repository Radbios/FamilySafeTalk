...
### SOLUÇÕES ###
 ...
 1. Implementar um chat com controle parental, onde permitiria os pais a personalizar as configurações de segurança do aplicativo do filho, assim como monitorá-lo;
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>
              [ ] Acesso Simplificado ao Histórico;
          </li>
        </ul>
      </td>
      <td>
