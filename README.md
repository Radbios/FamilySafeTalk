...
| MARCOS  | FUNCIONALIDADES | DATA |
| ------------- | ------------- | ------------- |
| **<div align="center">Definição de Requisitos</div>** <br> A definição dos requisitos é o ponto de partida crucial para o desenvolvimento do nosso aplicativo. Isso nos assegura que nossas metas estejam bem claras e que todos estejam na mesma página quando se trata do que precisamos. |   |<div align="center">07/12/2023</div>|
| **<div align="center">Protótipo da Interface do Usuário</div>**<br> Apresentação visual e interativa da interface do usuário, permitindo a validação da experiência de uso para crianças e responsáveis.|   | <div align="center">xx/yy/zzzz</div>|
|**<div align="center">Implementação do Front-End</div>**<br> Desenvolvimento completo da interface do usuário para dispositivos móveis, assegurando uma experiência fluida e intuitiva.| <ul><li>[ ] Estrutura e Navegação</li><li>[ ] Design Responsivo</li><li>[ ] Entrada de Dados Amigável</li><li>[ ] Feedbacks Visuais</li><li>[ ] Acessibilidade</li></ul>| <div align="center">xx/yy/zzzz</div>|
|**<div align="center">Autenticação e Configuração de Conta Inicial</div>**<br> Implementação parcial da API, permitindo cadastro, autenticação e a configuração inicial para os usuários (crianças e responsáveis) do aplicativo.|<ul><li>[ ] Cadastro</li><li>[ ] Autenticação</li><li>[ ] Vínculo de criança(s) & responsável(eis)</li><li>[ ] Personalização de Perfil de usuário</li></ul>| <div align="center">xx/yy/zzzz</div>|
|**<div align="center">Controle de Contatos</div>**<br> Implementação da funcionalidade de adicionar novos amigos à rede da criança, assim como ver, buscar, deletar contatos e monitorar os amigos de seu protegido no aplicativo.|<ul><li>[ ] Adição de contatos</li><li>[ ] Remoção de contatos</li><li>[ ] Bloqueio de contatos</li><li>[ ] Buscar contatos</li><li>[ ] Ver contatos</li></ul>| <div align="center">xx/yy/zzzz</div>|
|**<div align="center">Chat</div>**<br> Implementação do sistema de chat, permitindo a comunicação entre responsáveis e amigos, assim como  o monitoramento das conversas dos protegidos por parte dos responsáveis (tempo real?).|<ul><li>[ ] Chat entre usuários</li><li>[ ] Visualizar conversas de seu(s) protegido(s)</li></ul>| <div align="center">xx/yy/zzzz</div>|
|**<div align="center">Configurações de Controle</div>**<br> Implementação das configurações avançadas de Controle Parental, oferecendo aos responsáveis ferramentas avançadas para monitoramento, restrição de conteúdo e gestão de interações sociais.| <ul><li>[ ] Controle de amizades</li><li>[ ] Configuração de conversa</li><li>[ ] Logs de Atividades</li><li>[ ] Filtro de Palavras-Chaves</li><li>[ ] Relatório de uso</li></ul>| <div align="center">xx/yy/zzzz</div>|
|**<div align="center">Configurações de Privacidade Infantil</div>**<br> Permite que as crianças personalizem facilmente quem pode interagir com elas.|<ul><li>[ ] Ver contatos bloqueados</li><li>[ ] Configuração de conversa</li></ul>|<div align="center">xx/yy/zzzz</div>|
